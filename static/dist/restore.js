...
var backupDir = window.backupDir;
var dbDir = window.dbDir;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getBackupList: function getBackupList() {
      try {
        var list = [];
        fs.readdirSync(backupDir).forEach(function (item) {
          var filePath = path.join(backupDir, item);
          var fileName = item;
          var state = fs.statSync(filePath);
          if (state.isDirectory()) {
            list.push({ filePath: filePath, fileName: fileName });
          }
        });
    ...
    restore: function restore(file) {
      ...
      this.$modal.show('dialog', {
        ...
        buttons: [{
          ...
          title: '确定',
          handler: function handler() {
            _this.doRestore(file);
          }
        }]
      });
    },
    doRestore: function doRestore(file) {
      var _this2 = this;
    ...
    deleteDir: function deleteDir(dir) {
      var _this3 = this;
    ...
    copyDir: function copyDir(src, dest) {
      var _this4 = this;
      ...
      dirs.forEach(function (item) {
        ...
        if (temp.isFile()) {
          ...
          _this4.copyDir(itemPath, path.join(dest, item));
        }
      });
    },
    tryMkdir: function tryMkdir(dest) {
      try {
        fs.mkdirSync(dest);
      } catch (e) {
        console.error(e);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_js_modal__ = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Restore_vue__ = __webpack_require__(145);



window.Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_js_modal___default.a, { dialog: true })
/* eslint-disable no-new */
const instacne = new window.Vue({
  el: '#app',
  render: h => h(__WEBPACK_IMPORTED_MODULE_1__Restore_vue__["a" /* default */])
})

function errorAlert(text) {
  console.log(__WEBPACK_IMPORTED_MODULE_0_vue_js_modal___default.a)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Restore_vue__ = __webpack_require__(114);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_24714958_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Restore_vue__ = __webpack_require__(148);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-24714958"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_24714958_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Restore_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "other_screens\\src\\Restore.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-24714958", Component.options)
  } else {
    hotAPI.reload("data-v-24714958", Component.options)
  }
...
var update = __webpack_require__(15)("68da367c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-24714958\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Restore.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-24714958\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Restore.vue");
...
// module
exports.push([module.i, "\n.page[data-v-24714958] {\r\n  background: #bbe6d6;\r\n  color: #2c3e50;\n}\n.title[data-v-24714958] {\r\n  padding: 16px;\r\n  padding-left: 30px;\r\n  display: -webkit-box;\r\n  display: -ms-flexbox;\r\n  display: flex;\r\n  -webkit-box-orient: horizontal;\r\n  -webkit-box-direction: normal;\r\n      -ms-flex-direction: row;\r\n          flex-direction: row;\r\n  -webkit-box-align: center;\r\n      -ms-flex-align: center;\r\n          align-items: center;\r\n  position: relative;\r\n  -webkit-box-flex: 0;\r\n      -ms-flex: 0 0 32px;\r\n          flex: 0 0 32px;\r\n  z-index: 1;\r\n  background: #bbe6d6;\r\n\r\n  font-size: 18px;\r\n  font-weight: bold;\n}\n.list-wrapper[data-v-24714958] {\r\n  -webkit-box-flex: 1;\r\n      -ms-flex: 1;\r\n          flex: 1;\r\n  display: -webkit-box;\r\n  display: -ms-flexbox;\r\n  display: flex;\r\n  -webkit-box-pack: center;\r\n      -ms-flex-pack: center;\r\n          justify-content: center;\r\n  -webkit-box-align: stretch;\r\n      -ms-flex-align: stretch;\r\n          align-items: stretch;\r\n  padding: 10px;\r\n  /* background: saddlebrown; */\n}\n.list[data-v-24714958] {\r\n  -webkit-box-flex: 1;\r\n      -ms-flex: 1;\r\n          flex: 1;\r\n  max-width: 800px;\r\n  /* margin: auto; */\r\n  border-radius: 6px;\r\n  background: #e4f5ef;\r\n  padding: 10px;\r\n  overflow: auto;\n}\n.list-item[data-v-24714958] {\r\n  display: -webkit-box;\r\n  display: -ms-flexbox;\r\n  display: flex;\r\n  -webkit-box-pack: justify;\r\n      -ms-flex-pack: justify;\r\n          justify-content: space-between;\r\n  -webkit-box-align: center;\r\n      -ms-flex-align: center;\r\n          align-items: center;\r\n  color: #2c3e50;\r\n  font-size: 18px;\r\n  height: 40px;\r\n  padding: 5px;\r\n  font-weight: 700;\n}\n.list-item[data-v-24714958]:hover {\r\n  background: #bbe6d6;\n}\n.dialog[data-v-24714958] {\r\n  color: #6b7c93;\r\n  word-break: break-all;\n}\n.backup[data-v-24714958] {\r\n  color: #42b983;\r\n  cursor: pointer;\n}\r\n", ""]);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "title" }, [_vm._v("数据还原")]),
      _vm._v(" "),
        ...
        _c(
          ...
          _vm._l(_vm.list, function(i) {
            return _c(
              ...
              [
                _c("div", [_vm._v(_vm._s(i.fileName))]),
                _vm._v(" "),
                _c("div", { staticClass: "backup" }, [_vm._v("还原")])
              ]
            )
          })
        )
      ...
      _vm._v(" "),
      _c("v-dialog", { staticClass: "dialog" })
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-24714958", esExports)
  }
}
